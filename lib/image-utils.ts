export const getProductImage = (product: any) => {
  ...
  const categoryMap: Record<string, string> = {
    smartphones: "/images/products/generic-smartphone.jpg",
    iphone: "/images/products/generic-iphone.jpg",
    samsung: "/images/products/generic-samsung.jpg",
    google: "/images/products/generic-pixel.jpg",
    laptops: "/images/products/generic-laptop.jpg",
    macbook: "/images/products/generic-macbook.jpg",
    tablets: "/images/products/generic-tablet.jpg",
    ipad: "/images/products/generic-ipad.jpg",
    headphones: "/images/products/generic-headphones.jpg",
    speakers: "/images/products/generic-speaker.jpg",
    cameras: "/images/products/generic-camera.jpg",
    tvs: "/images/products/generic-tv.jpg",
    gaming: "/images/products/generic-gaming.jpg",
    wearables: "/images/products/generic-smartwatch.jpg",
    accessories: "/images/products/generic-accessory.jpg",
    chargers: "/images/products/generic-charger.jpg",
    cables: "/images/products/generic-cable.jpg",
    cases: "/images/products/generic-case.jpg",
    "power banks": "/images/products/generic-powerbank.jpg",
    "screen protectors": "/images/products/generic-screen-protector.jpg",
    keyboards: "/images/products/generic-keyboard.jpg",
    "mobile gaming": "/images/products/generic-mobile-gaming.jpg",
    "usb hubs": "/images/products/generic-usb-hub.jpg",
  }

  // Check if the product category matches any in our map
  if (product.category) {
...
export const getImageFallback = (category?: string) => {
  if (!category) return "/images/placeholder-product.jpg"

  const categoryLower = category.toLowerCase()

  if (categoryLower.includes("iphone") || categoryLower.includes("apple")) {
    return "/images/products/generic-iphone.jpg"
  } else if (categoryLower.includes("samsung")) {
    return "/images/products/generic-samsung.jpg"
  } else if (categoryLower.includes("smartphone")) {
    return "/images/products/generic-smartphone.jpg"
  } else if (categoryLower.includes("laptop")) {
    return "/images/products/generic-laptop.jpg"
  } else if (categoryLower.includes("tablet")) {
    return "/images/products/generic-tablet.jpg"
  } else if (
    categoryLower.includes("headphone") ||
    categoryLower.includes("earphone") ||
    categoryLower.includes("earbud")
  ) {
    return "/images/products/generic-headphones.jpg"
  } else if (categoryLower.includes("speaker")) {
    return "/images/products/generic-speaker.jpg"
  } else if (categoryLower.includes("camera")) {
    return "/images/products/generic-camera.jpg"
  } else if (categoryLower.includes("tv")) {
    return "/images/products/generic-tv.jpg"
  } else if (categoryLower.includes("gaming")) {
    return "/images/products/generic-gaming.jpg"
  } else if (categoryLower.includes("watch") || categoryLower.includes("wearable")) {
    return "/images/products/generic-smartwatch.jpg"
  } else if (categoryLower.includes("charger")) {
    return "/images/products/generic-charger.jpg"
  } else if (categoryLower.includes("cable")) {
    return "/images/products/generic-cable.jpg"
  } else if (categoryLower.includes("case")) {
    return "/images/products/generic-case.jpg"
  } else if (categoryLower.includes("power bank")) {
    return "/images/products/generic-powerbank.jpg"
  } else if (categoryLower.includes("screen protector")) {
    return "/images/products/generic-screen-protector.jpg"
  } else if (categoryLower.includes("keyboard")) {
    return "/images/products/generic-keyboard.jpg"
  } else if (categoryLower.includes("usb") || categoryLower.includes("hub") || categoryLower.includes("adapter")) {
    return "/images/products/generic-usb-hub.jpg"
  }
